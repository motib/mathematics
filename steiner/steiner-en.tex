...
\end{center}
\begin{quote}
Now, the length of $AK$ equals the length of $PQ$ and line $AH$ is parallel to $A'H'$. It remains to construct a line segment $AS$ of lenght equal to $AK$ on the line containing $AH$.
\vspace*{-8pt}
\end{quote}

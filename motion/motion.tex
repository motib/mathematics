...
\draw (0,0) -- (0,6);
\draw[dashed] (0,6) -- (10,6);
\draw[thick] (0,3) -- node[above,xshift=1mm,yshift=3mm] {$\displaystyle\frac{1}{m}-\frac{1}{2m}$} (2,2);
\draw[thick] (2,2) -- node[above,xshift=-3mm,yshift=3mm] {$\displaystyle\frac{1}{m}+\frac{1}{2m}$} (7,6);
\draw[dashed] (2,2) -- (2,0);
\draw[dashed] (2,2) -- (0,2);
\draw[dashed] (7,6) -- (7,0);

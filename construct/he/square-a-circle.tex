...
האיור שלהלן מתמקד על חלק מהאיור למעלה. קטעי קו המקווקווים נוספו. בגלל שכל המעגלים הם מעגלי היחידה, קל לראות שאורך כל אחד מהקטעים המקווקווים הוא 
$1$.
מכאן ש-%
$\overline{AOCD}$
הוא מעויין, ולען האלכסונים שלו ניצבים אחד לשני וחוצים אחד את השני ב-%
$K$.
מכאן ש-%
...
לפי משפט פתגורס במשולש ישר-הזווית
$\triangle QOT$:
\[
\overline{QT} = \sqrt{1^2-\left(\frac{2}{3}\right)^2}=\frac{\sqrt{5}}{3}\,.
\]
$\triangle PSR$
הוא משולש ישר-זווית כי הוא כולא קוטר. לפי משפט פתגורס:
\[
...
ו-%
$\triangle OAS$ 
הוא משולש ישר-זווית. לפי משפט פתגורס:
\begin{form}{1.5}

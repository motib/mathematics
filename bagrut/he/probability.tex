...
שאלה זו מאוד ארוכה אבל לא קשה במיוחד, כי ניתן לפתור אותה באמצעות נוסחת ברנולי בלבד.
...
וההסתברות שהיא ענתה תשובה לא נכונה היא המשלים ל-%
$1$:
\[
1-\frac{1}{4-k}=\frac{4-k-1}{4-k}\,.
\]
כדי לקבל ציון 
\textbf{בדיוק}
$100$
...
תלמיד 
$\ldots$
שלא עבר את המבחן. מה ההסתברות שהוא נעזר בחבריו?"}
...
$B$:
\[
P(\textrm{I} \cup \textrm{II}) = P(\textrm{I}\:-\:\textrm{I}) + P(\textrm{II}\:-\:\textrm{I}) + P(\textrm{I} \cap \textrm{II})\,.
\]
...
\]
ההסתברות במונה: כדי שגלית תנצח במשחק וגם בסיבוב הראשון, היא חייבת לנצח בסיבוב הראשון וגם ב-%
$2$
או
$3$
או
...
\textsf{b}
את מספר הכדורים הכחולים בקופסה I. בתרשים, בכל צומת רשום שני זוגות של מספרים: מספר הכדורים האדומים ומספר הכדורים הכחולים בקופסה I,
...
$b=5$.
נסכם את ההסתברויות להוציא כדור אדום מקופסה II:
\[
\erh{18pt}
\begin{array}{l}
...
\begin{array}{c}
P(\textrm{II}\ \textrm{\R{נשארו שלושה אדומים בקופסה}}/\textrm{II}\ \textrm{\R{הוציאו כדור אדום מקופסה}}) =\\
\displaystyle\frac{P(\textrm{II}\ \textrm{\R{נשארו שלושה אדומים בקופסה}} \cap \textrm{II}\ \textrm{\R{הוציאו כדור אדום מקופסה}})}{P(\textrm{II}\ \textrm{\R{הוציאו כדור אדום מקופסה}})}
\end{array}
\]
נשארו שלושה כדורים אדומים רק אם היו אברעה כדורים אדומים לפני הבחירה. ההסתברות במונה היא 
...
נסמן ב-%
$D$
את האירוע "לדייר יש קלנועית" ואת ההסתברות שלו ב-%
$p$.
לפי נוסחת ברנולי:
\[
...
האפשרויות לקבל שוויון הן: )א( ניצחון אחד לאנה וליעל, או )ב( תיקו בשני המשחקים. ההסתברות לתיקו היא המשלים לסכום ההסתברויות שאחת מהן תנצח:
\[
...
נסכם את ההסתברויות להצלחה של נבחנים מהמושב, הקיבוץ והעיר:
\[
P(S)=0.70=P(K\cap S)+0.35+2.5\cdot P(K\cap S)\,.
\]
נקבל
$P(K\cap S)=0.1$
ולפי היחס הנתון
...
"$\frac{1}{8}$
\textbf{מן}
הנבחנים שהיו ממושבים נכשלו" מכוון להסתברות מותנית, לעומת הניסוח "ההסתברות לבחור באקראי
\textbf{מבין כל}
הנבחנים נבחן שהיה מהעיר
\textbf{וגם}
הצליח במבחן" מכוון לחיתוך הסתברויות, כי ההסתברות לבחור אחד "מכל הנבחנים" היא 
$1$:
\[
...
\end{array}
\]
לא כתוב במפורש אבל נניח שהמשחקים בלתי תלויים, ונבנה עץ )מופיע בעמוד הבא( שמציג את תוצאות שני המשחקים. סימנו את המסלולים בהם דן זכה ב-%
$100$
והמסלולים בהם דן לא זכה ב-%
$50$
באף אחד משני המשחקים. חישוב ההסתברות המותנית נותן:
\[
...
בחירה של ספרת העשרות ואחר כך ספרת היחידות מכוונת לעץ הסתברויות. כדי לפשט את התרשים רשמתי בכל צומת את ההסתברויות )אי-זוגי,זוגי(, ולא את מספר הספרות.
...
במספר זוגי הספרה האחרונה זוגית. הניסוח
"\textbf{אם ידוע ש-}"
מכוון להסתברות מותנית:
\vspace{-5ex}
\[
...
ניתן לחשב את ההסתברות "ספרה אחרונה זוגית" במכנה לפי המידע בעץ או פשוט לשים לב שהיא המשלימה להסתברות הנתון בסעיף א של "הספרה האחרונה אי-זוגית"
$1-\frac{4}{7}=\frac{3}{7}$.

חישוב ההסתברות במונה לפי המסלול העליון בעץ עבור בחירה של שתי ספרות זוגיות:
\[
...
כל קבוצה היא בחירה בלתי תלוייה. לפי נוסחת ברנולי ההסתברות לבחור בדיוק שני גברים
\textbf{בקבוצה אחת}
היא:
\[
{4 \choose 2}\left(\frac{2}{3}\right)^2\left(1-\frac{2}{3}\right)^2=\frac{8}{27}\,.
\]
כדי לקבל את ההסתברות שיהיו בדיוק שני גברים בשתי הקבוצות, נעלה ערך זה בריבוע:
\[
...
\end{array}
\]
החיתוך במונה שקולה ל-"בדיוק שני גברים"
$\frac{8}{27}$
שחישבנו בסעיף א, כי "לכל היותר שני גברים" היא 
$0,1,2$
...
אני מלאתי את טבלת ההסתבוריות לפי חישוב לא פורמלי.
...
\[
0.75 \times \textrm{\R{בחרו במסלול א}} = 0.36\,,
\]
ולכן 
$0.36/0.75=0.48$
מהתלמידים בחרו מסלול א. כעת ניתן נמלא את טבלת ההסתברויות:
...
נחשב את הערכים בטבלה בצורה יותר מפורשת תוך שימוש בהסתברות מותנית:
\[
...
\textbf{יותר}
מנקודה אחת מסומנים בכוכביות. ההסתברות של האירוע היא:
\[
...
הניסוח
"\textbf{ידוע כי}"
מכוון להסתברות מותנית והחיתוך מצטמצם כי אם יש תיקו אחד וניצחון של דני אז דני צבר לפחות נקודה אחת:
\vspace{-2ex}
\[
\erh{18pt}
\begin{array}{c}
...
נחשב את המונה על ידי חיבור ההסתברויות של שני מסלולים בעץ המסומנים ב-%
$\#$.
ההסתברות במכנה חושבה בסעיף ב:
\[
...
כעת נמלא את הטבלה לפי הסתברויות משלימות:
\begin{center}
\selectlanguage{english}
\begin{tikzpicture}[scale=1.4]
\draw (0,0) grid (3,3);

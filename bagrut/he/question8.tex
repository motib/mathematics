...
$x=a$:
\[
S=\frac{4}{a}\cdot \frac{\sqrt{a}}{2} + \int_{\frac{\sqrt{a}}{2}}^a \frac{1}{x^2} dx=\frac{2}{\sqrt{a}} + \frac{-1}{a} - \frac{-1}{\frac{\sqrt{a}}{2}}=\frac{4}{\sqrt{a}}-\frac{1}{a}=\frac{4\sqrt{a}-1}{a}\,.
\]
...
\[
\left(\frac{4\sqrt{a}-1}{a}\right)'=\frac{2\sqrt{a}\cdot 1 - (4\sqrt{a}-1)}{a^2}=\frac{-2\sqrt{a}+1}{a^2}\,,
\]
שמתאפסת ב-%
$a=\frac{1}{4}$.
...
&=&6\cdot \left(\frac{x^2-6x+18}{6-x}\right)\,.
\end{equationarray*}
נחשב את נגזרת הראשונה )ללא הקבוע
$6$(:
\erh{12pt}
\begin{equationarray*}{rcl}
S'&=&\frac{(2x-6)(6-x)+ -1\cdot (x^2-6x+18)}{(6-x)^2}\\
...
&=& \frac{-x^3+2k^2x-2x^3}{2\sqrt{k^2-x^2}}\\
...
k^3&=&27\\
k&=&3\\
x&=&\sqrt{\frac{2}{3}}k=\sqrt{\frac{2}{3}}\cdot 3=\sqrt{6}\,.
\end{equationarray*}
...
השאלה ארוכה מאוד ועלול להרתיע תלמידים!
...
רואים בגרפים שעבור
$x>0$,
השיפוע, הנגזרת הראשונה, יורדת, כך שהנגזרת השנייה שלילית. מכפלה של שני ערכים שליליים היא חיובית.
...
\draw[thick,dashed] (axis cs:-2,1) -- (axis cs:4,1);

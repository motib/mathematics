...
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של הוצאת הכדורים}}\label{fig.summer-2017b.1}
\end{center}
\end{figure}
...
;
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של המשחקים}}\label{fig.winter-2017.1}
\end{center}
\end{figure}
...
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של בחירת הספרות}}\label{fig.summer-2015a.1}
\end{center}
\end{figure}
...
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של בחירת הספרות}}\label{fig.summer-2015a.2}
\end{center}
\end{figure}
...
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של בחירת הספרות}}\label{fig.summer-2015a.3}
\end{center}
\end{figure}
...
\end{tikzpicture}
\caption{\R{עץ ההסתברויות של אפשרויות האכילה}}\label{fig.summer-2015b.1}
\end{center}
\end{figure}
